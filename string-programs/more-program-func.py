...
print("length of the string", len(anotherStr))

print("check string is present or not--->","hello" in anotherStr)

print("find the string-->", anotherStr.find("hello"))

str="Hello, WorlD"
print("with case fold function--->", str.casefold())
print("with lower case function-->", str.lower())

sharp_s = "Straße"
print("with case fold function--->", sharp_s.casefold())
print("with lower case function-->", sharp_s.lower())
